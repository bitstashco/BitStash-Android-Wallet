...
public final class PinPagesAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
    ...
    private java.util.List<io.horizontalsystems.bitstashwallet.modules.pin.PinPage> pinPages;
    @org.jetbrains.annotations.Nullable()
    private java.lang.Integer shakePageIndex;
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<io.horizontalsystems.bitstashwallet.modules.pin.PinPage> getPinPages() {
        return null;
    }
    
    public final void setPinPages(@org.jetbrains.annotations.NotNull()
    java.util.List<io.horizontalsystems.bitstashwallet.modules.pin.PinPage> p0) {
    }
