...
public final class ViewHolderCoin extends androidx.recyclerview.widget.RecyclerView.ViewHolder implements kotlinx.android.extensions.LayoutContainer {
    ...
    app.odapplications.bitstashwallet.modules.balance.BalanceViewItem balanceViewItem, boolean expanded, boolean chartEnabled) {
    }
    ...
    private final void showFiatAmount(app.odapplications.bitstashwallet.modules.balance.BalanceViewItem balanceViewItem) {
    }
    
    private final void showChart(app.odapplications.bitstashwallet.modules.balance.BalanceViewItem viewItem, boolean expanded, boolean chartEnabled, int fiatAmountVisibility) {
    }
    ...
    app.odapplications.bitstashwallet.modules.balance.BalanceCoinAdapter.Listener listener) {
        super(null);
    }
}