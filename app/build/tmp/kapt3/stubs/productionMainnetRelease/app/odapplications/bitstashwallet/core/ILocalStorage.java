...
public abstract interface ILocalStorage {
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract app.odapplications.bitstashwallet.modules.send.SendModule.InputType getSendInputType();
    ...
    public abstract app.odapplications.bitstashwallet.entities.SyncMode getSyncMode();
    
    public abstract void setSyncMode(@org.jetbrains.annotations.NotNull()
    app.odapplications.bitstashwallet.entities.SyncMode p0);
    
    @org.jetbrains.annotations.NotNull()
    public abstract app.odapplications.bitstashwallet.modules.balance.BalanceSortType getSortType();
    
    public abstract void setSortType(@org.jetbrains.annotations.NotNull()
    app.odapplications.bitstashwallet.modules.balance.BalanceSortType p0);
    
    @org.jetbrains.annotations.NotNull()
    public abstract app.odapplications.bitstashwallet.lib.chartview.ChartView.ChartType getChartMode();
