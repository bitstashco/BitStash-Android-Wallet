    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(10) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoRate.equals(_existingRate)) {
          return new RoomOpenHelper.ValidationResult(false, "Rate(app.odapplications.bitstashwallet.entities.Rate).\n"
                  + " Expected:\n" + _infoRate + "\n"
                  + " Found:\n" + _existingRate);
        }
        ...
        if (! _infoEnabledWallet.equals(_existingEnabledWallet)) {
          return new RoomOpenHelper.ValidationResult(false, "EnabledWallet(app.odapplications.bitstashwallet.entities.EnabledWallet).\n"
                  + " Expected:\n" + _infoEnabledWallet + "\n"
        ...
        if (! _infoPriceAlertRecord.equals(_existingPriceAlertRecord)) {
          return new RoomOpenHelper.ValidationResult(false, "PriceAlertRecord(app.odapplications.bitstashwallet.entities.PriceAlertRecord).\n"
        ...
        if (! _infoAccountRecord.equals(_existingAccountRecord)) {
          return new RoomOpenHelper.ValidationResult(false, "AccountRecord(app.odapplications.bitstashwallet.core.storage.AccountRecord).\n"
                  + " Expected:\n" + _infoAccountRecord + "\n"
